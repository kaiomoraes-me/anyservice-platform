...
/** Manages CRUD operations for service listings (the marketplace catalog). */
@Service
public class ServiceListingService {
    ...
    /** Creates a new service listing owned by the given provider. */
    @Transactional
    ...
    /** Returns all service listings ordered by most recent. */
    ...
    /** Returns service listings filtered by category. */
    @Transactional(readOnly = true)
    ...
    /** Returns all service listings created by a specific provider. */
    @Transactional(readOnly = true)
    ...
    /** Returns a single service listing by its ID. */
    @Transactional(readOnly = true)
    ...
    /** Deletes a service listing if the requesting user is the owner. */
    @Transactional
    ...
    /** Converts a ServiceListing entity to its DTO representation. */
