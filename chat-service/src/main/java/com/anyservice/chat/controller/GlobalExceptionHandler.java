...
import com.anyservice.chat.dto.MessageResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> handleNoHandlerFoundException(NoHandlerFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new MessageResponse("Recurso nÃƒÆ’Ã‚Â£o encontrado"));
    }
