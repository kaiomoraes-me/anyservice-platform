package com.anyservice.notification.controller;

import com.anyservice.notification.dto.MessageResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> handleNoHandlerFoundException(NoHandlerFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new MessageResponse("Recurso nÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â£o encontrado"));
    }
